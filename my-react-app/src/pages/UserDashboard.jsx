      ...
      <div className="flex-1 overflow-y-auto px-10 py-12 relative transition-all duration-500">
        ...
        <div className="max-w-6xl mx-auto w-full pt-4">
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className={`col-span-12 lg:col-span-8 group relative rounded-[3rem] p-10 overflow-hidden shadow-2xl transition-all duration-500 border
               ...
               <div className="relative z-10">
                  ...
                  {nextAppointment ? (
                     <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        <div>
                           <h2 className={`text-5xl font-black mb-4 tracking-tighter transition-colors group-hover:text-blue-400 ${isDark ? 'text-white' : 'text-slate-900'}`}>
            ...
            <div className="col-span-12 grid grid-cols-1 md:grid-cols-3 gap-8">
               {[
                  ...
                  <div key={i} onClick={() => navigate(item.path)} 
                     className={`group cursor-pointer border rounded-[2.5rem] p-8 transition-all shadow-xl hover:-translate-y-1

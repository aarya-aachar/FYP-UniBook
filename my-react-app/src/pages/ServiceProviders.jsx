      ...
      <div className="flex-1 overflow-y-auto px-10 py-12 relative">
        ...
        <div className="mb-12 fade-in">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-5xl font-black tracking-tight">{serviceName}</h1>
        ...
        {/* Providers Grid */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8 fade-in [animation-delay:100ms]">
          {loading ? (
             [1,2,3,4].map(i => (
